...
from .va_libero_action_lang_smoke_train_cfg import va_libero_action_lang_smoke_train_cfg
...
VA_CONFIGS = {
    ...
    'libero_action_lang_smoke_train': va_libero_action_lang_smoke_train_cfg,
