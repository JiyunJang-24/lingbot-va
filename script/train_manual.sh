...
#
# Fine-tune only action-specific modules:
#   bash script/train.sh --finetune_only_action
#
# Fine-tune action modules plus transformer LoRA adapters:
...
export DATASET_DIR="${DATASET_DIR:-$REPO_ROOT/datasets/libero_manual_action_lingbot}"
...
export SAVE_ROOT="${SAVE_ROOT:-$REPO_ROOT/train_out/libero_manual_action_only_wo_lora}"
